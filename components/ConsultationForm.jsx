...
export default function ConsultationForm() {
  ...
  if (!date) timePlaceholder = "Pick a date first";
    ...
    if (availability.reason === "CLOSED") timePlaceholder = "Closed on this date";
    else if (availability.reason === "PAST") timePlaceholder = "That date has passed";
    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      <div className="md:col-span-2">
        ...
        <textarea
          ...
          placeholder="Concerns, goals, prior treatments — anything that helps us prepare. Optional."
        />
      </div>
      ...
      <div className="md:col-span-2 flex items-center justify-between gap-4 pt-3">
        <p className="text-[12px] text-ink/55 max-w-md">
          Your consultation is a confirmed 30-minute booking. No treatment on the day, no pressure.
        </p>
        <button
          type="submit"
