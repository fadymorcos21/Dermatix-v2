...
export const services = [
  ...
  },
  {
    ...
    story: [
      "Cryolipolysis is for pockets, not pounds. A targeted area of pinchable fat is cooled through an applicator so fat cells can be affected while the skin surface is protected by the device protocol.",
